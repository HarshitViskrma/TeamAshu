...
We are in the process of creating a unique platform designed to connect buyers and sellers directly, thereby removing the necessity for any intermediaries in the transaction process. This innovative approach allows sellers on our platform to enjoy a 0% commission fee when they sell their products, which empowers them to offer their goods at the best possible prices. By streamlining the buying and selling experience, we aim to foster a more efficient marketplace that benefits both parties involved, ultimately enhancing the overall shopping experience.​
...
1. #### clone the repo using this command
   ```bash
   git clone https://github.com/HarshitViskrma/TeamAshu.git
   ```
